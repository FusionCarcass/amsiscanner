...
namespace AmsiScanner.Common {
    public static class AmsiUtility {
        ...
        static AmsiUtility() {
            ...
            int resultCode = NativeMethods.AmsiInitialize(string.Format("{0}_{1}_{2}", "PowerShell", "C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe", Environment.OSVersion.Version.ToString()), out AmsiUtility._context);
        ...
        private static void Swap() {
            ...
            AmsiUtility._session = (IntPtr)amsiSessionField.GetValue(null);
